...
export const SERVICE_CATALOG: ServiceCatalog[] = [
    ...
    },
    {
        ...
        description: 'Reparación o reemplazo de teclado de laptop o computadora',
        basePrice: 100.00,
        laborHours: 2,
        category: 'hardware',
        includesTravel: false,
    ...
    {
        id: 'svc-014',
        name: 'Reparación de Sistema de Refrigeración',
        description: 'Limpieza, reparación o reemplazo de ventiladores y sistema de refrigeración',
        basePrice: 100.00,
        laborHours: 2,
        category: 'maintenance',
        includesTravel: false,
    },
    {
        ...
        description: 'Diagnóstico y reemplazo de pantalla o panel LCD/LED',
        basePrice: 150.00,
        laborHours: 2,
        category: 'hardware',
        includesTravel: false,
    },
    {
        ...
        description: 'Reemplazo de batería dañada o degradada en laptop',
        basePrice: 80.00,
        laborHours: 1,
        category: 'hardware',
        includesTravel: false,
    },
    {
        ...
        description: 'Reparación o reemplazo del puerto de carga de la laptop',
        basePrice: 120.00,
        laborHours: 2,
        category: 'hardware',
        includesTravel: false,
    ...
    {
        id: 'svc-018',
        name: 'Reparación de Puertos USB/HDMI',
        description: 'Diagnóstico y reparación de puertos USB, HDMI y otros conectores',
        basePrice: 100.00,
        laborHours: 2,
        category: 'hardware',
        includesTravel: false,
    ...
    {
        id: 'svc-019',
        name: 'Reparación de Pantalla Táctil',
        description: 'Diagnóstico y reemplazo de digitalizador o pantalla táctil',
        basePrice: 150.00,
        laborHours: 2,
        category: 'hardware',
        includesTravel: false,
    },
    {
        ...
        description: 'Instalación y configuración de memoria RAM adicional',
        basePrice: 50.00,
        laborHours: 1,
        category: 'hardware',
        includesTravel: false,
    ...
    {
        id: 'svc-021',
        name: 'Actualización de Drivers y Configuración',
        description: 'Actualización de controladores y configuración de dispositivos',
        basePrice: 50.00,
        laborHours: 1,
        category: 'software',
        includesTravel: false,
    ...
    {
        id: 'svc-022',
        name: 'Reparación de Wi-Fi y Bluetooth',
        description: 'Diagnóstico y reparación de problemas de conectividad Wi-Fi y Bluetooth',
        basePrice: 60.00,
        laborHours: 1,
        category: 'network',
        includesTravel: false,
    ...
    {
        id: 'svc-023',
        name: 'Reparación de GPU',
        description: 'Diagnóstico, limpieza y optimización de tarjeta gráfica y controladores',
        basePrice: 120.00,
        laborHours: 2,
        category: 'hardware',
        includesTravel: false,
    },
    {
        ...
        description: 'Diagnóstico y solución de problemas de sonido, drivers y dispositivos de audio',
        basePrice: 60.00,
        laborHours: 1,
        category: 'software',
        includesTravel: false,
